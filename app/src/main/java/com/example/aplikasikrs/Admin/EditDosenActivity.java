...
public class EditDosenActivity extends AppCompatActivity {
    ...
    private void requestUpdateDosen(){
        ...
        Call<DefaultResult> call =  service.update_dosen(edtId.getText().toString(),edtNama.getText().toString(),edtNidn.getText().toString(),
                edtAlamat.getText().toString(),edtEmail.getText().toString(),edtGelar.getText().toString(),"https://pbs.twimg.com/profile_images/988598148091269121/TWFZoPHC_400x400.jpg",
                "72170119");
        call.enqueue(new Callback<DefaultResult>() {
            @Override
            public void onResponse(Call<DefaultResult> call, Response<DefaultResult> response) {
                progressDialog.dismiss();
                Toast.makeText(EditDosenActivity.this,"Update Berhasil",Toast.LENGTH_LONG).show();
